The first Rust Foundation [security initiative report]() was created this month, which summarizes its progress since the inception of the program. The Foundation plans to publish these reports regularly.
