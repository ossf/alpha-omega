The Rust Project goal for implementing an verifiable mirroring prototype has been accepted. There are two Alpha-Omega blog posts now live, one on vulnerability surfacing and the other on Capslock. And there is infra, interop and other updates.
...
The cargo-cgsec [blog post](https://alpha-omega.dev/blog/measuring-least-privilege-introducing-cargo-capslock/) for Alpha-Omega was published, detailing the progress of implementing Capslock for Rust.
